      ...
      jint aTagCount, jint lSearchTimeout)
{
   ...
   /* Find constructor */
   lTagConstructor = (*aEnv)->GetMethodID(aEnv, lTagClass, "<init>", "(Ljava/lang/String;Lorg/libdmtx/DMTXPoint;Lorg/libdmtx/DMTXPoint;Lorg/libdmtx/DMTXPoint;Lorg/libdmtx/DMTXPoint;)V");
   if(lTagConstructor == NULL)
      return NULL;

   /* Find Point class */
   lPointClass = (*aEnv)->FindClass(aEnv, "org/libdmtx/DMTXPoint");
   if(lPointClass == NULL)
      return NULL;

   /* Find constructor */
   lPointConstructor = (*aEnv)->GetMethodID(aEnv, lPointClass, "<init>", "(II)V");
   if(lPointConstructor == NULL)
      return NULL;
